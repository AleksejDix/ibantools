...
export const autogeneratedCountrySpecs = {
  ...
  EE: {
    chars: 20,
    bban_regexp: '^[0-9]{2}[0-9]{14}$',
    IBANRegistry: true,
    SEPA: true,
    bank_identifier: '0-1',
    account_indentifier: '6-20',
  },
  EG: {
    chars: 29,
